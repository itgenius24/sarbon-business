...
<g filter="url(#filter0_d_2001_4347)">
<mask id="path-1-outside-1_2001_4347" maskUnits="userSpaceOnUse" x="2" y="1" width="46" height="31" fill="black">
        ...
        {locationData &&
          locationData.map((item) => (
            <Placemark
              ...
              options={{
                iconLayout: "default#image",
                iconImageHref:getSVGIcon(item?.bid_cash,item?.order_status[0]),
                iconImageSize: [60, 72],
                iconImageOffset: [-15, -42],
              }}
              onBalloonOpen={(e) => {
