...
import GalaxyStore from "@/assets/images/galaxy-store.png";
...
export const Footer = () => {
  ...
  return <Box as="footer" pt="64px" pb="48px" bgColor={pathname.includes("/auth") ? "gray" : "baseWhite"}>
    <Container>
      <div className={cls.footerContent}>
        <div className={cls.infoListWrapper}>
          ...
          <ul className={cls.infoList}>
            <li className={cls.infoItem}>
              <Link className={cls.infoLink} href="/">Расчет расстояний</Link>
            </li>
            <li className={cls.infoItem}>
              <Link className={cls.infoLink} href="/">Партнерская программа</Link>
            </li>
            <li className={cls.infoItem}>
              <Link className={cls.infoLink} href="/">Звезды Logistics на вашем сайте</Link>
            </li>
            <li className={cls.infoItem}>
              <Link className={cls.infoLink} href="/">Средние ставки</Link>
            </li>
          </ul>
        </div>
        <div className={cls.infoListWrapper}>
          <p className={cls.infoListTitle}>Безопасность</p>
          <ul className={cls.infoList}>
            <li className={cls.infoItem}>
              <Link className={cls.infoLink} href="/">Проверки партнеров, водителей и ТС</Link>
            </li>
            <li className={cls.infoItem}>
              <Link className={cls.infoLink} href="/">Памятка по проверке контрагентов</Link>
            </li>
            <li className={cls.infoItem}>
              <Link className={cls.infoLink} href="/">Светофор+</Link>
            </li>
            <li className={cls.infoItem}>
              <Link className={cls.infoLink} href="/">Страхование</Link>
            </li>
            <li className={cls.infoItem}>
              <Link className={cls.infoLink} href="/">О формировании Паспорта</Link>
            </li>
          </ul>
        </div>
        <div className={cls.infoListWrapper}>
          ...
          <ul className={cls.infoList}>
            <li className={cls.infoItem}>
              <Link className={cls.infoLink} href="/">О системе Logistics</Link>
            </li>
            <li className={cls.infoItem}>
              <Link className={cls.infoLink} href="/">Контактная информация</Link>
            </li>
            <li className={cls.infoItem}>
              <Link className={cls.infoLink} href="/">Реклама на сайте</Link>
            </li>
            <li className={cls.infoItem}>
              <Link className={cls.infoLink} href="/">Тарифы</Link>
            </li>
            <li className={cls.infoItem}>
              <Link className={cls.infoLink} href="/">О формировании Паспорта</Link>
            </li>
        ...
        <div className={cls.infoListWrapper}>
          ...
          <ul className={cls.infoList}>
            <li className={cls.infoItem}>
              <Link className={cls.infoLink} href="/">Блог</Link>
            </li>
            <li className={cls.infoItem}>
              <Link className={cls.infoLink} href="/">Эксклюзивные материалы</Link>
            </li>
            <li className={cls.infoItem}>
              <Link className={cls.infoLink} href="/">Политика конфиденциальности</Link>
            </li>
            <li className={cls.infoItem}>
              <Link className={cls.infoLink} href="/">Общие положения</Link>
            </li>
            <li className={cls.infoItem}>
              <Link className={cls.infoLink} href="/">Карта сайта</Link>
            </li>
          </ul>
        </div>
      </div>
      <div className={cls.footerSocials}>
        <div className={cls.mobileApps}>
          <p className={cls.mobileAppsHeading}>Мобильные приложения Logistics</p>
          <ul className={cls.mobileAppList}>
            ...
            <li className={cls.mobileAppItem}>
              <a className={cls.mobileAppLink} href="/" target="_blank">
                <Image src={GalaxyStore} alt="Galaxy store" width={147} height={40} />
              </a>
            </li>
          </ul>
        </div>
        <ul className={cls.socialList}>
          ...
          <li className={cls.socialItem}>
            <a className={cls.socialLink} href="/" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <g clipPath="url(#clip0_174_21794)">
