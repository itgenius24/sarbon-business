...
export const DigitalFacts = ({
  ...
  return <Box py="96px">
    <Heading textAlign="center" mb="20px" fontSize="36px" lineHeight="44px">{t("Мы в цифрах")}</Heading>
    <Text color="brand.600" textAlign="center" fontSize="20px" lineHeight="30px">{t("Наши данные в цифрах для более точного информации")}</Text>
